...
const service = services.find((item) => item.slug === "nettoyage-voiture");

export const metadata: Metadata = {
  title: "Nettoyage voiture intérieur & extérieur | LES PORTES D'AZUR",
  description:
    "Nettoyage voiture intérieur extérieur avec matériel fourni. Résultat visible, devis gratuit et réponse rapide."
};
...
const jsonLd = {
  ...
  serviceType: "Nettoyage voiture intérieur extérieur"
};
      ...
      <section className="section bg-white">
        <div className="container grid gap-12 lg:grid-cols-[2fr_1fr]">
          <div>
            ...
            <p className="mt-4 text-sm text-slate-500">Matériel fourni • Travail soigné • Devis gratuit</p>
          </div>
        ...
        <div className="container mt-8">
          <div className="card p-6">
            ...
            <p className="mt-3 text-sm text-slate-600">
              Poussières, taches, salissures incrustées, résidus et odeurs sont traités avec soin.
              Nous utilisons des produits adaptés aux surfaces pour respecter votre véhicule.
            </p>
